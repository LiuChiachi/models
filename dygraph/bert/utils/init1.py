...
def init_from_static_model(dir_path, cls_model, bert_config):
    ...
    """
    cls_model.bert_layer._sub_layers["layer_norm_0"].set_dict(
    {
        "weight": _param0,
        "bias": _param1
    })
    ...
    for _i in range(bert_config["num_hidden_layers"]):
        ...
        """
        cls_model.bert_layer._encoder.layers[_i].self_attn.q_proj.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
        ...
        cls_model.bert_layer._encoder.layers[_i].self_attn.k_proj.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
        ...
        cls_model.bert_layer._encoder.layers[_i].self_attn.v_proj.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
        ...
        cls_model.bert_layer._encoder.layers[_i].self_attn.out_proj.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
        ...
        """
        cls_model.bert_layer._encoder.layers[_i].norm1.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
        ...
        """
        cls_model.bert_layer._encoder.layers[_i].norm2.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
        ...
        cls_model.bert_layer._encoder.layers[_i].linear1.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
        ...
        """
        cls_model.bert_layer._encoder.layers[_i].linear2.set_dict({
                "weight": _param_weight,
                "bias": _param_bias
            })
